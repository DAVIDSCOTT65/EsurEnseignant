<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="competence.aspx.cs" Inherits="ESUR_GUI.pages.competence" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ESUR RDC | Competence</title>
  ...
  <div id="topnav">
    <ul>
      ...
      <li class="active"><a href="identification.aspx">Identification</a>
        <ul>
          <li><a href="competence.aspx">Mes comp�tences</a></li>
  ...
  <div id="container">
    <div class="topbox">
        <form action="#" method="post" runat="server">
            <h3>Enregistrement des comp�tences</h3>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="txtDate" runat="server" Width="408px" Height="46px">
                            ...
                            <asp:ListItem>Tr�s bien</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
